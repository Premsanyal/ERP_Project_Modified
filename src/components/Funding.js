import { Card, CardContent, Button, Badge, Progress } from '../ui.js';
import { Plus } from 'lucide-react';

const requests = [
    { id: 1, title: "High-Performance Computing Cluster Access", requestor: "Dr. Sarah Chen", dept: "Computer Science", amount: 25000, status: "approved", priority: "high" },
    { id: 2, title: "Microscopy System", requestor: "Dr. Emily Watson", dept: "Biomedical Engineering", amount: 150000, status: "pending", priority: "medium" },
    { id: 3, title: "Lab Space Renovation", requestor: "Dr. Rachel Adams", dept: "Psychology", amount: 75000, status: "pending", priority: "low" }
];
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="space-y-4">
                {requests.map(r => (
                    <Card key={r.id} className="!p-0 bg-card/50 border-border"><CardContent className="p-4">
